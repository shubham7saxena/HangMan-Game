...
class MainWindow(Frame):
        ...
        def init(self):
                ...
                #new game button
                self.NewGameButton = Button(self.MenuBarFrame,text="Play Again!",command = lambda: NewGame())
                ...
                print('Word to be guessed is : *** '+self.GuessWord+' *** ')
        ...
        def HangHim(self):
                ...
                if(attempts == 1):
                        self.canvas.create_line(80,250,120,250,width=5)
                        self.canvas.create_line(100,20,100,250,width=5)
                        self.canvas.create_line(100,20,250,20,width=5)
                        self.canvas.create_line(250,20,250,60,width=5)

                if(attempts == 2):
                        self.canvas.create_oval(230,60,270,100,width=5)

                if(attempts == 3):
                        self.canvas.create_line(250,100,250,160,width=5)
        
                if(attempts == 4):
                        self.canvas.create_line(250,120,230,130,width=5)        
                
                if(attempts == 5):                      
                        self.canvas.create_line(250,120,270,130,width=5)
                ...
                if(attempts == 6):
                        self.canvas.create_line(250,160,230,170,width=5)

                if(attempts == 7):
                        self.canvas.create_line(250,160,270,170,width=5)
